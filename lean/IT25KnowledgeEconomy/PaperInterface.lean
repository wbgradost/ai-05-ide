...
- `discreteOutputStrictlyHigherSpec` -> `discreteOutputStrictlyHigher`: Proposition 6, part 1 (output comparison; discrete specialization), Main text p. 27, item 1; Online Appendix Lemma 2.10, pp. 27.
-/

namespace IT25KnowledgeEconomy

/--
Proposition 6, part 1 (output comparison; discrete specialization)

Paper statement: Overall output is strictly higher with autonomous than non-autonomous AI.

Source location: Main text p. 27, item 1; Online Appendix Lemma 2.10, pp. 27
...
-/
def discreteOutputStrictlyHigherSpec : Prop :=
  forall q : Real, (2 / 5 : Real) < q -> q < (4 / 5 : Real) -> (4 / 5 : Real) + 2 * q < (8 / 5 : Real) + q
