...
- Version formalized: arXiv v11 (2025-02-25)
...
|---|---|---|---|---|
| Proposition 6, part 1 (output comparison; discrete specialization) (Main text p. 27, item 1; Online Appendix Lemma 2.10, pp. 27) | `discreteOutputStrictlyHigherSpec` -> `discreteOutputStrictlyHigher` | compiled partial specialization | `PaperInterface.lean`; `ProofInterface.lean` | The endpoint is closed by `linarith` and the paper-scoped fast check passes; raw-source-to-expanded-Spec judgment and premise provenance remain outside this partial run. |
