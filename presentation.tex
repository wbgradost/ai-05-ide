...
\begin{center}
\IfFileExists{hand/derivation.jpg}{\includegraphics[width=.7\linewidth]{hand/derivation.jpg}}{\fbox{\parbox{.72\linewidth}{\centering\vspace{1em}The author's photograph of the hand derivation will be inserted here.\\[.5em]No synthetic handwriting is used.\vspace{1em}}}}
\end{center}
\end{frame}
...
\small
Lean target: \texttt{discreteOutputStrictlyHigher q} abbreviates
\texttt{4/5 + 2*q < 8/5 + q}.  The endpoint theorem assumes
...
$4/5-q>0$. It verifies this arithmetic implication and its stated domains.
