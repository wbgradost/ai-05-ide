...
\begin{frame}{12. Handwritten derivation}
\begin{center}
\includegraphics[height=.78\textheight,keepaspectratio]{hand/derivation.jpg}
\end{center}
\end{frame}
...
\item Lean checks one honest discrete output mechanism, complemented by the
      author's handwritten discrete derivation.
\end{itemize}
\end{frame}
